    ...
    confirmAddIncome() {
        try {
            if (this.state.money && this.state.selectedCategory.id && this.state.date) {
                firebaseApp.database().ref('/income_recurring_transactions').push({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ flexDirection: "row" }}>
                    ...
                    <View style={{ width: 53, height: 53, marginRight: 20, backgroundColor: "green", borderRadius: 28, justifyContent: "center", alignItems: "center" }}>
